                ...
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">+917356064321</span>
                            <a href="https://api.whatsapp.com/send?phone=7356064321&text=Hi%20Ashwin,I'm.." className="contact__button">Write me <i
